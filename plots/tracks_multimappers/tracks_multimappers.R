setwd("/tungstenfs/scratch/ggrossha/gypafoiv/projects/GROUP_PROJECTS/rajani/small_RNAs_Rajani/plots/tracks_multimappers/")
...
WT_A_plus_path <- "../../01_small_RNA_seq_15_C/results/wild_type_A/bowtie/alignment.sorted.filtered.1_alignment_per_read.plus.bw"
WT_A_minus_path<- "../../01_small_RNA_seq_15_C/results/wild_type_A/bowtie/alignment.sorted.filtered.1_alignment_per_read.minus.bw"
Dpf_3_null_A_plus_path <- "../../01_small_RNA_seq_15_C/results/Dpf_3_null_A/bowtie/alignment.sorted.filtered.1_alignment_per_read.plus.bw"
Dpf_3_null_A_minus_path <- "../../01_small_RNA_seq_15_C/results/Dpf_3_null_A/bowtie/alignment.sorted.filtered.1_alignment_per_read.minus.bw"
mut_2_A_plus_path <- "../../01_small_RNA_seq_15_C/results/mut_2_A/bowtie/alignment.sorted.filtered.1_alignment_per_read.plus.bw"
mut_2_A_minus_path <- "../../01_small_RNA_seq_15_C/results/mut_2_A/bowtie/alignment.sorted.filtered.1_alignment_per_read.minus.bw"
mut_7_A_plus_path <- "../../01_small_RNA_seq_15_C/results/mut_7_A/bowtie/alignment.sorted.filtered.1_alignment_per_read.plus.bw"
mut_7_A_minus_path <- "../../01_small_RNA_seq_15_C/results/mut_7_A/bowtie/alignment.sorted.filtered.1_alignment_per_read.minus.bw"
# total RNAs
total_rna_WT_A_str1_path <- "../../02_total_RNAseq_15_C/results/wild_type_A/STAR/wild_type_A_Signal.UniqueMultiple.str1.out.bw"
total_rna_WT_A_str2_path <- "../../02_total_RNAseq_15_C/results/wild_type_A/STAR/wild_type_A_Signal.UniqueMultiple.str2.out.bw"
total_rna_Dpf_3_null_A_str1_path <- "../../02_total_RNAseq_15_C/results/Dpf_3_null_A/STAR/Dpf_3_null_A_Signal.UniqueMultiple.str1.out.bw"
total_rna_Dpf_3_null_A_str2_path <- "../../02_total_RNAseq_15_C/results/Dpf_3_null_A/STAR/Dpf_3_null_A_Signal.UniqueMultiple.str2.out.bw"
total_rna_mut_2_A_str1_path <- "../../02_total_RNAseq_15_C/results/mut_2_A/STAR/mut_2_A_Signal.UniqueMultiple.str1.out.bw"
total_rna_mut_2_A_str2_path <- "../../02_total_RNAseq_15_C/results/mut_2_A/STAR/mut_2_A_Signal.UniqueMultiple.str2.out.bw"
total_rna_mut_7_A_str1_path <- "../../02_total_RNAseq_15_C/results/mut_7_A/STAR/mut_7_A_Signal.UniqueMultiple.str1.out.bw"
total_rna_mut_7_A_str2_path <- "../../02_total_RNAseq_15_C/results/mut_7_A/STAR/mut_7_A_Signal.UniqueMultiple.str2.out.bw"
